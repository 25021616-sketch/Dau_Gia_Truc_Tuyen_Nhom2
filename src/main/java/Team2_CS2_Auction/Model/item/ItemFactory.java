...
public class ItemFactory {
    public static Item createItem(String id, String ten, String loai, String moTa, String imagePaths) {
        // Đảm bảo các lớp con (Electronics, Art...) cũng có Constructor nhận 5 tham số này
        return switch (loai) {
            ...
            default -> new Other(id, ten, loai, moTa, imagePaths);
        };
    }
}